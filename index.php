        ...
        <div class="hero_slider_container">
            <div class="hero_slider owl-carousel">
                ...
                <div class="hero_slide">
                    <img src="<?php echo at_public()."images/carousel1.jpg";?>" alt="carousel_image" class="hero_slide_background carousel1 img-fluid">
                    <div class="overlay" style="opacity: .1;"></div>
                </div>

                <!--Hero Slide 2-->
                <div class="hero_slide">
                    <img src="<?php echo at_public()."images/carousel2.jpg";?>" alt="carousel_image" class="hero_slide_background carousel2 img-fluid">
                ...
                <!--Hero Slide 3-->
                <div class="hero_slide">
                    <img src="<?php echo at_public()."images/carousel3.jpg";?>" alt="carousel_image" class="hero_slide_background carousel3 img-fluid">
                    <div class="overlay"></div>
                    <div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
                        <div class="hero_slide_content text-center">
            ...
            <div class="row fatwa_boxes">
                ...
                <div class="col-lg-4 fatwa_box" data-aos="<?php $i++; if($i%3 == 1) {echo "fade-left";} elseif($i%3 == 2){echo "zoom-in";} elseif($i%3 == 0){echo "fade-right";}?>" data-aos-duration="1300">
                    <div class="card p-0 hover-shadow">
                        <a href="#"><img class="card-img-top" src="<?php echo at_public().$specialize['card_image']; ?>" alt="aqida_image"></a>
                        <div class="card-body">
                            <a href="#">
            ...
            <div class="row row-eq-height">
                ...
                <div class="col-lg-6 nopadding">
                    ...
                    <div class="search_section d-flex flex-column align-items-center justify-content-center">
                        <div class="search_background" style="background-image:url(<?php echo at_public()."images/search_background.jpg";?>)"></div>
